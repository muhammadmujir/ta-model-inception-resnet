...
def main():
    ...
    # with open(args.train_path, 'r') as outfile:        
    #     train_list = json.load(outfile)
    # with open(args.test_path, 'r') as outfile:       
    #     val_list = json.load(outfile)
    train_list = glob.glob(os.path.join(args.train_path, '*.jpg'))
    val_list = glob.glob(os.path.join(args.test_path, '*.jpg'))
    resultPath = args.result_path
    
    model = MSCnn(load_weights=True)
